 ...
 */
final class Version20201216143400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, user_id INT DEFAULT NULL, texte LONGTEXT NOT NULL, date DATETIME NOT NULL, INDEX IDX_B6BD307F59027487 (theme_id), INDEX IDX_B6BD307FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
